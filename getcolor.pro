...
;           white
;
;     NB!!  Not all of the above colors seem to work, but using the actual code names
;           such as skyblue, coral etc. works!
;
...
FUNCTION GETCOLOR, thisColor, index, TRUE=truecolor, $
   ...
   names  = [ names, 'Powder Blue',   'SkyBlue', 'Steel Blue','Dodger Blue', 'Royal Blue',       'Blue' ]
...
IF StrUpCase(thisColor) EQ 'SKY' THEN thisColor = 'SKYBLUE'
